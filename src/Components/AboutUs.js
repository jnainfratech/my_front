        ...
        <TabPanel className='tab' value="1">
            <div className='TabContent'>
                <div className='TabText'>
                    <p className='TabSlogan'>If You Can Dream it , you can do it</p>
                    ...
                    <p className='TabPara'>
For standardized outputs, designs, and drawings for repetitive tasks or structures, please feel free to contact us at <p style={{fontWeight:"700"}}>support@conceptcelerio.in</p>   We are committed to delivering high-quality and efficient solutions to meet your specific needs. Whether you require consistent designs or drawings for routine projects or want to streamline repetitive tasks, our team is dedicated to providing top-notch services tailored to your requirements. Get in touch with us today, and let's work together to enhance your workflow and achieve better results. Looking forward to collaborating with you!</p>
                </div>
